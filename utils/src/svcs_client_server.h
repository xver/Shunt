...
typedef enum {SVCS_INT,SVCS_BYTE,SVCS_REAL,SVCS_STRING,SVCS_A_STRUCTURE,SVCS_INT4S,SVCS_BYTE4S,SVCS_HEADER_ONLY} SVCV_INSTR_ENUM;
#define SVCV_INSTR_HASH_INDEX_DEFINE char* SVCV_INSTR_ENUM_NAMES[] = {"SVCS_INT","SVCS_BYTE","SVCS_REAL","SVCS_STRING","SVCS_A_STRUCTURE","SVCS_INT4S","SVCS_BYTE4S","SVCS_HEADER_ONLY"}
